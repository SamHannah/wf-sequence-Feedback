  ...
  sidebarLayout(position = "left",
    sidebarPanel(
      fluidRow(
        ...
        fluidRow(
          column(4,
                 selectInput("N_subjects", "Number of iterations per simulation",choices=c(5, 25, 100, 200,500), selected = 5)
            ),          
          column(4,
                 sliderInput("Feed", "Level of positive feedback", min = 0.0, max=1.0, step=0.1, value=0.3)
            ),
